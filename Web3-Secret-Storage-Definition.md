...
This version fixes several inconsistencies with the version 1 published [here](https://github.com/vaporyco/go-vapory/wiki/Passphrase-protected-key-store-spec). In brief these are:
