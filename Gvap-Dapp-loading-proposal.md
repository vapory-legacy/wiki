---
name: Gvap DAPP Loading Proposal
category: 
---
...
1. Dapp packages can be downloaded as .zip/.rlp/.dapp
    ...
    - and a `swarm.json`, with all the file paths and hashes, [see here](https://github.com/vaporyco/go-vapory/wiki/URL-Scheme#server-config-examples))
