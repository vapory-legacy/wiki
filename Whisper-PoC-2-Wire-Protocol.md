...
Peer-to-peer communications between nodes running Whisper clients run using the underlying [ÐΞVp2p Wire Protocol](https://github.com/vaporyco/wiki/wiki/%C3%90%CE%9EVp2p-Wire-Protocol).
